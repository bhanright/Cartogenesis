...
| F36 Linux download and installation instructions | | queued after F35 (2026-09-15) | 2026-09-15 | | CI job on a Linux runner builds and uploads a .deb and a tarball on v* tags; per-platform installation sections in the release notes and on the site, Linux the fullest |
