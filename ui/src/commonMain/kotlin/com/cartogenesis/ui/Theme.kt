 ...
 * The fifteen named ones are a deliberate refusal of the usual "light, dark, auto" triple — the
 ...
 * in one style can put the whole window in it. The remaining ten are asked for by name — high
 * contrast, colour-blind, Allied, Hallowed, Baroque, Matrix, Hessian, Roman, Hitchcock, Lemon
 * Blueberry — and each is a room rather than a chart. Sixteen is more than a flat list can carry,
 * so [group] puts them on three shelves; nothing about a name or a stored value moves.
 *
...
enum class ThemeChoice(val label: String) {
     ...
     *
     * See [ChromeDetail]. Ten of the sixteen answer with something other than the default; the
