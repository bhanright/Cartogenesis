...
object Isobaths {
    ...
    fun flattestSlope(config: WorldGenConfig, width: Int, height: Int): Float {
        val kilometresPerCell = sqrt(config.nations.squareKilometresPerCell(width, height)).toFloat()
        return ABYSSAL_PLAIN_GRADIENT * kilometresPerCell * METRES_PER_KILOMETRE /
            config.climate.maxAltitudeMetres
    }
