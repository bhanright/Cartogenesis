package com.worldforge.app.export
...
import com.worldforge.app.render.MapPalette
...
object HdExporter {
    ...
    private fun save(context: Context, bitmap: Bitmap, seed: Long): Uri {
        val filename = "worldforge-$seed-${System.currentTimeMillis()}.png"
        val values = ContentValues().apply {
            put(MediaStore.Images.Media.DISPLAY_NAME, filename)
            put(MediaStore.Images.Media.MIME_TYPE, "image/png")
            put(
                MediaStore.Images.Media.RELATIVE_PATH,
                "${Environment.DIRECTORY_PICTURES}/Worldforge"
            )
