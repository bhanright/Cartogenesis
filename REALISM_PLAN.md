...
| F28 The Blacklight chrome | Opus | in progress on release/2.0, for 2.0.5 (2026-09-13) | 2026-09-13 | | William: "add a new chrome based around the colors #e6ff42 and #520c94" — a highlighter lime and a deep violet; named Blacklight by Fable (a lime glowing on violet is what a blacklight does), in the F24 manner: both arrangements built to the same rules and measured, the alarm derived from the pair and held off both by a 20.0 CIEDE2000 margin, every text pair at AA, the higher Stop contrast winning; seventeen chromes on the site's Features list. |
