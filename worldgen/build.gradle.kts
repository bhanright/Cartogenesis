...
val auditOnlyClasses = listOf(
    ...
    // X1d: the coastal valleys' spacing. Twenty-one whole worlds, seven of them at 2048, plus ten
    // controlled ones at 512 and a 2048 render pass. The finder it drives is shown reading a range
    // whose answer was written in by hand in `RangeFrontTest`, which is per-merge and costs
    // nothing, because it generates no world at all.
