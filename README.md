...
- **Generalisation.** The faintest rivers are dropped as you zoom out and return as you zoom in,
  following Töpfer and Pillewizer's radical law; the coast is traced as a simplified polyline over
  the raster. An export is drawn cell for pixel and loses nothing.
