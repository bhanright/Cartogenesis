...
val auditOnlyClasses = listOf(
    ...
    // X1d: the coastal valleys' spacing. Twenty-one whole worlds, seven of them at 2048, then ten
    // controlled worlds at 512 and fourteen at 2048, about thirty-five minutes in all. The finder
    // it drives is shown reading a range whose answer was written in by hand in `RangeFrontTest`,
    // which is per-merge and costs nothing, because it generates no world at all.
