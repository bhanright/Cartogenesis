...
| D3 Retire the determinism gate | | done | 2026-09-11 | 408beb4 (merge b278e7d) | ci.yml fingerprint step continue-on-error with ::warning::; README's three seed-only-save claims replaced; site CLAUDE.md needed nothing; memory note updated by the maintainer |
...
| F31 Bug reports: Help item with the seed, a line on the site | | queued for after the weekly reset (William, 2026-09-15) | 2026-09-15 | | Issues as the destination with a template; Help ▸ Report a bug… pre-fills seed, resolution, knobs, device; a Notes line on the site |
| F32 Roadmap chart and a feature-suggestion line on the site | | queued with F31 after the weekly reset (William, 2026-09-15) | 2026-09-15 | | ROADMAP.md as the source the page draws from, guarded; draft table in the section for William's edit |
