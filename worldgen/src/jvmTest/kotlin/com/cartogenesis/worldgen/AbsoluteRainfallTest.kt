...
class AbsoluteRainfallTest : BorrowsSharedWorlds() {
    ...
    fun `the calibration lands every audited seed's coast near 3000 mm and its desert core under 250`() {
        ...
        KnownFailures.expect("D I-9: the rainfall calibration's figures predate W2 and W3", "seed 42's windward coast at 3619 mm, seed 99's windward coast at 4076 mm") {
