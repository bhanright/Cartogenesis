...
| F13 Tints by climate and shading by sky (V1) | Opus | in progress on release/2.0; first pass 1055dfb returned for a second (2026-09-12, late) | 2026-09-12 | | First pass looked at by Fable on 718106 at 2048 before and after: three things sent back — isobaths paint ragged blotches on flat abyssal plains (the pixel-held band divided by a near-zero seabed gradient), steppe reads as full desert sand (the drought lift saturates on semi-arid ground), and the sheet is paler and flatter than the lamp (sky deviation 0.152 vs 0.171, plus the aerial veil on a plan view). Kept from the pass: eight lamps round the compass with a brightness-weighted horizon (cone 0 of 360 bearings unlit vs the lamp's 119), desert never green (Atlas 86.8% -> 0.0%), GPU parity worst channel 1 of 255, pen and ink pixel-identical, world untouched. |
