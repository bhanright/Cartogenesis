...
| F17 Not every coast is a ria | Opus | in progress on release/2.0; first pass f168b52 returned for a second (2026-09-13) | 2026-09-12 | | First pass: the fringe diagnosed as the lowstand's (box count +38% at 1 cell, +34% at 2, +7% at 16 against the lowstand off; the shelf remap moves the coast not at all, the plate noise under 1%); a littoral pass grades bays on the lowest 31% of shoreline (Luijendijk 2018's sandy share, taken directly because the two derivable heights bracket it at 1.9% and 59% and the gap is lithology), reach 23 km scaled by root fetch, fill only, never enclosing water; pooled dimension 1.207 -> 1.190 against Mandelbrot 1.25 +/- 0.15; smooth stretches 0.086 -> 0.122 against Earth's 0.31 (no barrier islands: K1); 74 ms at 2048. Returned by Fable: the x4 crops still show a tooth on nearly every cell of nearly every coast, because the spec's bullet on the lowstand's cell-scale amplitude was diagnosed and not acted on; second pass asked to make the 1-2 cell roughness no greater than the 4-16 cell roughness (self-similarity) by not resolving drowned valleys narrower than the cell as bays. |
| F18 Straight runs: D8 incision on smooth aprons | Opus | queued on release/2.0 after F17 (moves every world: its own render review) | 2026-09-13 | | From F15's diagnosis: over ground smooth at the cell scale D8 picks the same neighbour for cell after cell, stream-power incision cuts a dead-straight trench along it, and the trench ponds behind its own lip into a straight-bar lake (1-2 per map). LakeWaterBalance.jitter already breaks the bias inside endorheic re-routing; the same idea in FlowRouting.flowDirections (a seeded tie-break among near-equal descents, or D-infinity) does it everywhere. Guard: the census of 20+ cell straight bars at 0 on the five seeds, shown failing at 1/0/0/1/2; fingerprints re-pinned once; render and look. |
...
| W1 Energy balance and sea ice | Opus | in progress on main beside S2 (section written 2026-09-13) | 2026-09-13 | | |
