...
### F31. Bug reports: a Help item that carries the seed, and a line on the site — Opus, on `main`
...
- Small: one agent, a short one, after the weekly reset; no generator change.

### F32. A roadmap chart on the site, and a line asking for feature suggestions — Opus, on `main`
...
- **The chart**: a new section after Notes, "What comes next", a plain table — release, what
  ...
  bodies, waves and drift on the coasts (I1, K1–K4); 3.x metric-aware physics and a whole-world
  projection (P1), the globe view (F27), hydraulic rounds on the GPU (G1); 4.0 the full atlas
  with named continents, seas, bays, straits and ranges (V3); 5.0 only if William names it.
...
| F31 Bug reports: Help item with the seed, a line on the site | Opus | queued for after the weekly reset (William, 2026-09-15) | 2026-09-15 | | Issues as the destination with a template; Help ▸ Report a bug… pre-fills seed, resolution, knobs, device; a Notes line on the site |
| F32 Roadmap chart and a feature-suggestion line on the site | Opus | queued with F31 after the weekly reset (William, 2026-09-15) | 2026-09-15 | | ROADMAP.md as the source the page draws from, guarded; draft table in the section for William's edit |
