...
10. **This repository names no other site of the author's.** (William, 2026-09-12.) The
    generator's public home is cartogenesis.com. The personal site that also carries an older
    copy is a separate property: it is never named or linked in this repository, in release
    notes, in the app or on cartogenesis.com. Where the history has to refer to it, write
    "the author's site" or "the older mirror".
...
accent, thin rules instead of tonal cards. Dark: the author's site palette (see that repo's
...
### F12. JPEG, heightmap and layer exports — Opus, on `release/2.0`
...
### F23. A Natural map style — Opus, on `release/2.0`
...
### F24. The Lemon Blueberry chrome — Opus, on `release/2.0`
...
- **`ThemeChoice.LEMON_BLUEBERRY`**: a chrome whose two colours are what the name says — lemon
  ...
  Which is ground and which is ink is the agent's call, made by measuring: the arrangement that
...
### F25. Cloud cover — Opus, on `release/2.0`
...
### F29. Cool neutrals for Light, Dark and the site — Opus, on `release/2.0`

*William, 2026-09-14, after two opinions (Fable's and OpenAI Codex's) on a palette shift: "I agree
with your recommendation", and it applies to the website as well as the chrome. Codex's view,
...
rejected a cobalt-and-green chrome sampled from Natural. Fable's, adopted: agree on no landscape
...
- The agent measures rather than copies these values: every text pair through
...
### F30. The ruled lake shores in 364673's belt — Opus, on `main`
...
### Site 3. Style and layer strips — Opus, on `release/2.0`
...
no-cache, `[cartogenesis] ready in 0.7s`. The older mirror on the author's site keeps its copy and its
...
### S1. Units and time — Opus, on `main`
...
- **Every physical knob expressed in those units.** The stream-power coefficient K in
  ...
  as the 6 km and 8 km do, the agent picks one ruler, states which and why, and re-pins the
...
### S2. Coupled uplift and flexural isostasy — Opus, on `main`
...
### W1. Energy balance and sea ice — Opus, on `main`
