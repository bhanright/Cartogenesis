...
| F23 A Natural map style | Opus | in progress on release/2.0 (2026-09-13; the reference is a Blue Marble satellite view of North America) | 2026-09-13 | | |
...
| F25 Cloud cover | Opus | in progress on release/2.0 (2026-09-13) | 2026-09-13 | | |
...
| S2 Coupled uplift and flexural isostasy | Opus | in progress on main; first pass 551bd50, 74dcbe5, 8e1590a stopped by its own look and handed to a second agent (2026-09-13) | 2026-09-13 | | First pass: the absolute ruler, two crusts with Earth's densities (2,835 over 41 km continental, 2,900 over 7.1 km oceanic, mantle 3,300), Airy columns solved from Earth's 840 m mean land and 3,682 m mean ocean depth (thermal buoyancy 1,544 m), flexure by FFT with Te 30 km (flexural parameter 67 km; 460 ms at 2048, 1,436 at 4096, no GPU), uplift in the rounds at England and Molnar's class ratios scaled by the generator's own measured 0.101 mm/yr removal (collision 0.6 mm/yr), H1's decay factor replaced by exp(-300 Myr / 345 Myr), continents scattered rather than poured, the crust fraction from the slider. Guards passing: Whipple and Tucker steady state U^0.98 and K^-0.96; the trough 0.075-0.105 of the smaller mode (Earth 0.17; isostasy off 0.61-0.76); sea mode -3,932 m (Earth -3,700; -445 to -607 before); ice bed down 583 m against 556 predicted. Stopped because the pictures are worse: the deep ocean drawn as flat plate polygons (one level per plate, the Voronoi showing through 1,000 m of noise against 3,700 m of depth) and active belts as smooth pale stamps (the base noise cut from 7,300 to 2,000 m peak-to-peak to make the hypsometry bimodal, leaving 7% modulation at the belt's own scale); coastline 1.202 -> 1.136, islands 62 -> 15, ice 9.1% -> 3.1%, lakes 0.54% -> 3.33% of land all moved the wrong way; four test classes red, the other modules not run, the fixture stale. Second agent briefed with the cures the first identified: ocean floor depth from crustal age (Parsons and Sclater) with abyssal hills, a shaped rather than scaled relief spectrum, the spurious incision factor resolved against S1's derivation, and before/after renders from the merge base. | Second pass (c31374e, ee4f91d): the sea floor from crustal age (Parsons and Sclater, ridge -2,500 m, oldest -6,218, the spreading rate solved to Earth's 3,682 m mean depth, the plate polygons gone), a shaped relief spectrum (400 km corner, 700 m sd continental, 250 oceanic), the crust margin 600 -> 300 km and the shelf 469 -> 75 km at Earth's 130 m break, the clock re-solved 336,476 -> 126,179 years a round by dividing out S1's spurious factor, collision uplift 0.86 mm/yr from a measured denudation of 0.360; trough on every seed 0.121-0.164, sea mode -4,073, coverage within -187 to +112 m of the datum, coastline 1.128, islands 58, lake Pareto 1.048; belt band-pass relief 266 m against main's 200; 21 worldgen and 4 cartography guards still red, ui/desktop/site not run. Fable looked at the whole maps and the belt crop: the land has lost main's texture — a uniform pale shelf halo round every coast, interiors pocked with lakes (3.46% of land against Earth's 1.48% and main's 0.62%), the southern half of 59758 a drowned maze, a collision belt a smooth pale annulus round a flattish plateau with lakes ponded on it, rivers sparse, ice 5.1%; the histogram was made bimodal by cutting and then re-filtering the base relief. Third agent briefed with a changed approach: isostasy and uplift are long-wavelength physics and must sit under main's texture, not replace it — restore the base field as at 2eb0f0d on S1's ruler, apply the crust datum, the flexure, the uplift and the ocean's age-depth as corrections beneath it, reduce only the map-scale component if the trough needs it, and pass look guards against main (belt dissection including the rim, lakes at or under 1.5x Earth, no drowned interiors, coast, ice, drainage density) before the physics rows count. |
| S3 Erosion reads the climate | | queued for 3.0 (REALISM_AUDIT.md) | | | |
| W1 Energy balance and sea ice | Opus | in progress on main; first pass 11fc0ce, fcabf90, 137f49f returned for a second (2026-09-13) | 2026-09-13 | | First pass: a 1-D EBM (240 bands, 360 steps a year, 20 years, two columns per band on the world's own land fraction; A = 210.7 from Earth's 240 W/m2 at 14 C, D 0.60, ice line -10 C annual, zonal exchange 3.5) hits the band-mean profile (global 13.8, equator 26.4, 60 deg -2.2, pole -13.3) and the seasonal swing (land 35.6 C at 50-60, sea 5.6); glacialMaximumC a 3.2% dimmer sun through the feedback; sea ice at -1.8 C as two saved masks, the march takes nothing from ice; equatorTemperatureC, poleTemperatureC and continentality retired; FORMAT_VERSION 7 -> 8; F20's straight stripe gone on 59758. Returned by Fable: the guard held band means while the land column drifted cold — 718106 land annual +3.3 C at 40 deg against Earth's land ~+12, -10.1 at 60 against ~-2, an 8 C land-sea gap where Earth's is 2-4 — and the biome map shows the northern continents as tundra; second pass to guard land and sea columns separately, find the mechanism, and put the map's ice edge under a guard. Second pass (c41ea21): the columns guarded against Earth's lowland land and marine air at 0/20/40/60 within 4 C (80 reported: Earth's is an ice sheet 3 km up); the mechanism was shape, not size — the ice-free albedo now dips to 0.235 in the clear subtropics and rises under the ITCZ's cloud (a four-number fit to seven observations, ice-free mean 0.284), and the diffusivity falls as cos2 from 0.90 to 0.50 so the model carries 4.6/4.8/3.1 PW at 30/45/60 against Earth's 5.3/5.0/3.3 (Trenberth and Caron 2001); land and sea now within a degree of each other and of Earth at every latitude at sea level; the map's cold-season ice edge 49-51 -> 54-55 deg under a 45-70 guard. The 8 C land-sea gap on the map was the lapse rate on land standing 1,200-1,700 m up against Earth's 840 (M1's hypsometry, S2's to fix), not a column error; the slivers on 59758 are tundra on F18's straight-bar terrain, made visible by cooling. Still red, deliberately not patched: the sea band is one reservoir of water read by the coasts as air, so shoreline summers at 55-60 read 6 C where the air over Earth's sea reaches 10-13, and A6's warm-coast forests are gone (ColdCapReportTest 16/14/6% against 65/53/59, OceanCurrentTest +13.2% -> -2.4%, tundra 62/48/47/39% of land, taiga 1.5% -> 0.0% of the map). Third pass ordered by Fable: a marine-air temperature per sea band with the atmospheric column's capacity, coupled to the mixed layer by a bulk exchange, guarded against a reanalysis zonal climatology of 2 m air over ocean within 3 C, A6's guards back at their bars, tundra and boreal shares against Olson's biome areas. |
